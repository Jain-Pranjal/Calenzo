...
# SECRET_KEY = 'django-insecure-w8hp++b1mhdinpk%dkpr#2bq)zr=k-=1ia65x8q1gs-qc44^6c'
...
WSGI_APPLICATION = 'calenzo.wsgi.application'
...
# Media files (Images) for storing the images
MEDIA_URL = '/media/'
